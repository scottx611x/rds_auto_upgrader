...
class RDSInstanceTests(unittest.TestCase):
    ...
    def test_upgrade_path_potgres(self):
        self.assertEqual(make_rds_instance().upgrade_path,
                         ['9.4.18', '9.5.13', '9.6.9', '10.4'])

    def test_upgrade_path_mysql(self):
        rds_instance = make_rds_instance(db_engine="mysql",
                                         db_engine_version="5.5.46")
        self.assertEqual(rds_instance.upgrade_path,
                         ['5.6.40', '5.7.22'])
...
class RDSUpgraderTests(unittest.TestCase):
    ...
    def test_nothing_upgraded_if_rds_instance_never_available(self, *args):
        ...
        RDSUpgrader(ids=[test_instance_id],
